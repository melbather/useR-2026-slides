...
## Definitions {background-image="img/bg.png" background-opacity="0.7"}

(could delete this?)

N = The total number of animals… but where?
...
Find these slides at: https://github.com/melbather/useR-2026-slides

Find me at: https://statisticsmelissa.netlify.app

## References {background-image="img/bg.png" background-opacity="0.7"}
